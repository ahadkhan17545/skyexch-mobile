...
@Component({
  selector: 'app-palkihome',
  templateUrl: './palkihome.component.html',
  styleUrls: ['./palkihome.component.scss']
})
export class PalkihomeComponent implements OnInit {
  ...
  awcCasinoList_lcbuzz = [
    ...
    { sr: 9, prod_code: '59', prod_type: '2', name: "Chin SHJ Huang", prod_name: "JILI", game_code: 'JILI-SLOT-003', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Thorx", prod_name: "JILI", game_code: 'JILI-SLOT-052', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Roma X", prod_name: "JILI", game_code: 'JILI-SLOT-040', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Feng Shen", prod_name: "JILI", game_code: 'JILI-SLOT-022', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "God of Martial", prod_name: "JILI", game_code: 'JILI-SLOT-010', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Jungle King", prod_name: "JILI", game_code: 'JILI-SLOT-028', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Charge Buffalo", prod_name: "JILI", game_code: 'JILI-SLOT-026', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Jili Caishen", prod_name: "JILI", game_code: 'JILI-SLOT-060', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Boxing King", prod_name: "JILI", game_code: 'JILI-SLOT-031', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Fortune Gems", prod_name: "JILI", game_code: 'JILI-SLOT-043', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Golden Empire", prod_name: "JILI", game_code: 'JILI-SLOT-042', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Ali Baba", prod_name: "JILI", game_code: 'JILI-SLOT-049', prod_type_name: 'SLOT' },
  ...
  listCasinoProduct() {
    ...
    this.apiService.listCasinoProduct().subscribe((resp: any) => {
      if (resp.result) {
        ...
        this.awcCasinoList_lcbuzz.forEach(element2 => {
          resp.result.forEach((element, index) => {

            if (element.product == element2.prod_name || (!element2.prod_code && index == 0)) {
              awcCasinoList_lcbuzz.push(element2);
            }
          });
        });

        this.awcCasinoList_palki = awcCasinoList_palki;
        this.awcCasinoList_lcbuzz = awcCasinoList_lcbuzz;
      }
    })
  }
