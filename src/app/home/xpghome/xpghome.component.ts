...
@Component({
  selector: 'app-xpghome',
  templateUrl: './xpghome.component.html',
  styleUrls: ['./xpghome.component.scss']
})
export class XpghomeComponent implements OnInit {
  ...
  listCasinoProduct() {
    ...
    this.apiService.listCasinoProduct().subscribe((resp: any) => {
      if (resp.result) {
        ...
        // this.cricbuzzerawcList_OTHER = cricbuzzerawcList_OTHER;
        // this.cricbuzzerawcList_withoutlog=cricbuzzerawcList_withoutlog;
        // this.cricbuzzerawcList_withoutlog1=cricbuzzerawcList_withoutlog1;
        // this.cricbuzzerawcList_withoutlog1=cricbuzzerawcList_withoutlog1;
        // this.cricbuzzerawcList_VND = cricbuzzerawcList_VND;
