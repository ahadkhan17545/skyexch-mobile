...
@Component({
  selector: 'app-betexch9',
  templateUrl: './betexch9.component.html',
  styleUrls: ['./betexch9.component.scss']
})
export class Betexch9Component implements OnInit {
  ...
  awcCasino_kingmaker_betx = [
    ...
    { sr: 9, prod_code: '59', prod_type: '2', name: "Lucky Bingo", prod_name: "JILI", game_code: 'JILI-TABLE-020', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "Golden Umpire", prod_name: "JILI", game_code: 'JILI-SLOT-042', prod_type_name: 'SLOT' },
    { sr: 9, prod_code: '59', prod_type: '2', name: "777", prod_name: "JILI", game_code: 'JILI-SLOT-014', prod_type_name: 'SLOT' },
    ...
    this.casinoapiService.supernowaGameAssetsList(providerCode).subscribe((resp: any) => {
      ...
      if (resp.status.code == "SUCCESS") {
        ...
        let filterGameassetsbyprovider = resp.games.filter((pro) => {
          return this.providerList9xch.some((game) => {
